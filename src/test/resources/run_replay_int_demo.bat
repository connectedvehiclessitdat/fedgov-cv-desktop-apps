...
REM set DESIGN=-d
start /B javaw -cp fedgov-cv-desktop-apps-1.0.0-SNAPSHOT-jar-with-dependencies.jar gov.usdot.desktop.apps.gui.map.GeoPointsMapper %DESIGN% -g replay_int_data_gui_config.json
